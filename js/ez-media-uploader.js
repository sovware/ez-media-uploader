...
(function() {
  ...
  function createMediaPickerSection(data) {
    ...
    media_picker_icon_img.src = './images/cloud-upload-alt-solid.svg';
    media_picker_icon.appendChild(media_picker_icon_img);
  ...
  function createLoadingSection(show) {
    ...
    var loading_icon_img = createElementWithClass('ezmu__loading-icon-img', 'img');
    loading_icon_img.src = './images/spinner-solid.svg';
